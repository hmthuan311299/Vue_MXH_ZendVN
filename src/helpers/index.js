...
const replaceAll = (posts, strSearch, replaceString)=>{
    return posts.toLowerCase().split(strSearch.toLowerCase()).join(replaceString.toLowerCase())
}
export { removeVietnameseFromString, parseJwt, replaceAll, checkImageURL, checkImageFile }